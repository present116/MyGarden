          ...
          <div id="home-page-top">
            <div className="home-page-desc">
              <h1 className="home-page-title">
                <span className="shadow">{Name}</span>님<br />
                나뭇잎에 책을 등록해 보세요 &#128082;
              </h1>
            </div>
          </div>
        ...
        <div className="search-box">
          <div className="search-btn">
            <input
              ...
              placeholder="찾으시는 도서명 또는 저자를 입력해 주세요."
              value={Search}
              onChange={onSearchEvent}
            />
          </div>
          <button className="search-right" onClick={onSearchBtnEvent}>
            <div className="search-right-btn">
              <svg
